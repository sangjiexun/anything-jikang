...
const TRANSLATIONS = {
  ...
  settings: {
    ...
    "agent-skills": "代理技能",
    "agent_skills_title": "代理技能",
    "custom_skills_title": "自定义技能",
    "agent_flows_title": "代理流程",
    admin: "管理员",
    tools: "工具",
  ...
  thread: {
    ...
    could_not_create: "无法创建对话",
    deleted: "已删除的对话",
    rename_prompt: "请输入新的对话名称：",
    could_not_update: "对话更新失败！",
    delete_confirm: "确定要删除此对话吗？所有聊天记录将被删除，此操作无法撤销。",
    could_not_delete: "对话删除失败！",
    deleted_success: "对话删除成功！",
    rename: "重命名",
    delete: "删除对话",
  },
  "workspaces—settings": {
  ...
  agent: {
    ...
    mcp: {
      title: "MCP 服务器",
      description: "管理 MCP (Model Context Protocol) 服务器，为代理提供额外的工具和能力。",
      servers: "MCP 服务器",
      no_servers_found: "未找到 MCP 服务器",
      learn_more: "了解更多关于 MCP 服务器的信息",
      loading: "正在从配置文件加载 MCP 服务器...",
      refresh: "刷新",
      loading_refresh: "加载中...",
      refresh_confirm: "确定要刷新 MCP 服务器列表吗？这将重启所有 MCP 服务器并重新加载它们的工具。",
      server_status: {
        running: "运行中",
        stopped: "已停止",
        on: "开启",
      ...
      server_actions: {
        ...
        stop: "停止 MCP 服务器",
        delete: "删除 MCP 服务器",
        start_confirm: "确定要启动此 MCP 服务器吗？它将在下次启动服务器时自动启动。",
        stop_confirm: "确定要停止此 MCP 服务器吗？它将在下次启动服务器时自动启动。",
        delete_confirm: "确定要删除此 MCP 服务器吗？它将从配置文件中移除，您需要手动重新添加。",
        start_success: "MCP 服务器 {{name}} 启动成功",
        stop_success: "MCP 服务器 {{name}} 停止成功",
        delete_success: "MCP 服务器删除成功",
        toggle_error: "切换 MCP 服务器失败",
        delete_error: "删除 MCP 服务器失败",
        refresh_error: "刷新 MCP 服务器失败",
      },
      server_panel: {
        tools_available: "{{count}} 个工具可用",
        startup_command: "启动命令",
        command: "命令",
        arguments: "参数",
        not_running: "此 MCP 服务器未运行 - 可能已停止或在启动时遇到错误。",
        tool_name: "工具名称",
        tool_description: "工具描述",
        tool_call_arguments: "工具调用参数",
      },
      select_prompt: "选择一个代理技能、代理流程或 MCP 服务器",
    },
  },
  recorded: {
    title: "工作区聊天历史记录",
