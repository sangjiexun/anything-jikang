...
const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    attachment: {
      uploading: "上传中...",
      file_not_embedded: "文件未嵌入！",
      will_be_attached: "{{filename}} 将附加到此对话。它不会永久嵌入到工作区中。",
      image_attached: "图片已附加！",
      file_embedded: "文件已嵌入！",
      added_as_context: "已添加为上下文！",
      file_uploaded_embedded: "{{filename}} 已上传并嵌入到此工作区。现在可用于 RAG 聊天。",
      file_used_as_context: "{{filename}} 将仅用作此次对话的上下文。",
    },
